...
HD_PWD='D:/Document/FPGA Code/FMC125/FMC125.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADDA_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADDA_Top.tcl
